...
const baseInstruction = { id: 0, diceType: 1, modifier: 1, numberOfDiceToRoll: 1, timesToReroll: 1 }
const baseDetail = { id: 0, instructionId: 0, diceType: 1, modifier: 1, numberOfDiceToRoll: 1, value: 0 }
